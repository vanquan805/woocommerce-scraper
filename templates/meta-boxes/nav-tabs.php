<nav class="nav-tab-wrapper">
    <a href="#" data-target="#ws-scraper-metabox-category"
       class="nav-tab nav-tab-active"><?php _e('Category', 'woocommerce-scraper') ?></a>
    <a href="#" data-target="#ws-scraper-metabox-single-product"
